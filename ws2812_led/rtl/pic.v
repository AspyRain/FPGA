...
assign  data[3]  =  {8'hff,8'hff,8'hff}  ;	
assign  data[4]  =  {8'hff,8'hff,8'hff}  ;
...
assign  data[20]  =  {8'hff,8'hff,8'hff}  ;
...
assign  data[25]  =  {8'h00,8'h00,8'h00}  ;
assign  data[26]  =  {8'h00,8'h00,8'h00}  ;
assign  data[27]  =  {8'hff,8'hff,8'hff}  ;	
assign  data[28]  =  {8'hff,8'hff,8'hff}  ;
assign  data[29]  =  {8'h00,8'h00,8'h00}  ;
assign  data[30]  =  {8'h00,8'h00,8'h00}  ;
...
assign  data[36]  =  {8'hff,8'hff,8'hff}  ;
...
assign  data[43]  =  {8'h00,8'hff,8'h00}   ;
assign  data[44]  =  {8'h00,8'hff,8'h00} ;	
...
assign  data[52]  =  {8'h00,8'hff,8'h00}  ;	
...
assign  data[61]  =  {8'h00,8'hff,8'h00}  ;
...
assign  data[83]  =  {8'hff,8'hff,8'hff}  ;	
assign  data[84]  =  {8'hff,8'hff,8'hff}  ;
...
assign  data[91]  =  {8'hff,8'hff,8'hff}  ;	
assign  data[92]  =  {8'hff,8'hff,8'hff}  ;
...
assign  data[107]  =  {8'h00,8'hff,8'h00}   ;
assign  data[108]  =  {8'h00,8'hff,8'h00} ;	
...
assign  data[116]  =  {8'h00,8'hff,8'h00}  ;	
...
assign  data[124]  =  {8'h00,8'hff,8'h00}  ;
...
assign  data[131]  =  {8'hff,8'hff,8'hff}  ;	
assign  data[132]  =  {8'hff,8'hff,8'hff}  ;
...
assign  data[139]  =  {8'hff,8'hff,8'hff}  ;	
assign  data[140]  =  {8'hff,8'hff,8'hff}  ;
...
assign  data[155]  =  {8'hff,8'hff,8'hff}  ;	
assign  data[156]  =  {8'hff,8'hff,8'hff}  ;
...
assign  data[171]  =  {8'h00,8'hff,8'h00}   ;
assign  data[172]  =  {8'h00,8'hff,8'h00} ;	
...
assign  data[179]  =  {8'h00,8'hff,8'h00}  ;
...
assign  data[187]  =  {8'h00,8'hff,8'h00}  ;
...
assign  data[212]  =  {8'hff,8'hff,8'hff}  ;
assign  data[213]  =  {8'h00,8'h00,8'h00}  ;
assign  data[214]  =  {8'h00,8'h00,8'h00}  ;
assign  data[215]  =  {8'h00,8'h00,8'h00}  ;	
assign  data[216]  =  {8'h00,8'h00,8'h00}  ;//3
assign  data[217]  =  {8'h00,8'h00,8'h00}  ;
assign  data[218]  =  {8'h00,8'h00,8'h00}  ;
...
assign  data[227]  =  {8'hff,8'hff,8'hff}  ;	
assign  data[228]  =  {8'hff,8'hff,8'hff}  ;
...
assign  data[235]  =  {8'h00,8'hff,8'h00}   ;
assign  data[236]  =  {8'h00,8'hff,8'h00} ;	
...
assign  data[241]  =  {8'h00,8'h00,8'h00}  ;
assign  data[242]  =  {8'h00,8'h00,8'h00}  ;
assign  data[243]  =  {8'h00,8'hff,8'h00}  ;
assign  data[244]  =  {8'h00,8'h00,8'h00}  ;	
...
assign  data[250]  =  {8'h00,8'hff,8'h00}  ;
...
assign  data[18]  =   {8'hff,8'hff,8'hff}  ;
assign  data[19]  =   {8'hff,8'hff,8'hff}  ;	
...
assign  data[26]  =   {8'hff,8'hff,8'hff}  ;
assign  data[27]  =   {8'hff,8'hff,8'hff}  ;	
...
assign  data[34]  =   {8'hff,8'hff,8'hff}  ;
assign  data[35]  =   {8'hff,8'hff,8'hff}  ;	
...
assign  data[42]  =   {8'hff,8'hff,8'hff}  ;
